...
const NursingHomeInfoBlock = () => {
  const nursingHomeInfo = [
    { image: <ImageMiddle/>, name: "안부 요양원", address: "대전광역시 서구 관저동", religion: "기독교" },
    { image: <ImageMiddle/>, name: "안심 요양원", address: "대전광역시 서구 관저동", religion: "불교" },
    { image: <ImageMiddle/>, name: "안정 요양원", address: "대전광역시 서구 가수원동", religion: "원불교" },
    { image: <ImageMiddle/>, name: "안녕 요양원", address: "대전광역시 중구 둔산동", religion: "천주교" },
    { image: <ImageMiddle/>, name: "안산 요양원", address: "대전광역시 유성구", religion: "기독교" },
  ];
  ...
  return (
    <React.Fragment>
      <div className="div-nursingHomeScroll">
        ...
        <Link className="linkComponent" to="/rg/nh-info">
